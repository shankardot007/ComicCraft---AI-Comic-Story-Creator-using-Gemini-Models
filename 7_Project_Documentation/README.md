...
1. Launch the app (`uvicorn app.main:app --reload` inside `5_Project_Development`).
...
- Original project brief: `ComicCraft - AI Comic Story Creator using Gemini Models.pdf` (kept with the project assets).